...
if(empty($_SESSION['id'])){
   ...
   //prepare statementでSQL文の型を作る(DBとpostデータ照合させる)
   ...
   if(!empty($_SESSION['id']) && !empty($_SESSION['login_keep'])){
        ...
        setcookie('password',$_SESSION['password'],time()+60*60*24*7);   setcookie('login_keep',$_SESSION['login_keep'],time()+60*60*24*7);
